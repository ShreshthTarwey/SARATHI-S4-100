      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-primary/5 to-accent/10 relative overflow-hidden">
        <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
          {[
            ...
            <div
              key={i}
              className={`absolute animate-float-object-${
                (i % 3) + 1
              } opacity-20`}
              style={{
                left: `${5 + i * 15}%`,
                ...
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div className="text-left">
                    <h2 className="font-heading text-3xl font-bold text-foreground mb-4 flex items-center">
                      <span className="text-4xl mr-3 animate-bounce-fun">
                        🧠
                      </span>
                      Reshaping Young Minds
                    </h2>
                    <p className="font-body text-lg text-muted-foreground leading-relaxed mb-4">
                      Our interactive learning platform is scientifically
                      designed to enhance cognitive development, improve
                      communication skills, and build confidence in children
                      with special needs.
                    </p>
                    <p className="font-body text-lg text-muted-foreground leading-relaxed">
                      Through engaging games and activities, we help create new
                      neural pathways, strengthen memory, and develop essential
                      life skills in a fun, supportive environment.
                    </p>
                  </div>
                  <div className="flex justify-center">
                    <div className="relative">
                      <div className="w-48 h-48 bg-gradient-magical-purple rounded-full flex items-center justify-center animate-glow-pulse">
                        <span className="text-8xl animate-wiggle-dance">
                          🎯
                        </span>
                      </div>
            ...
            <Card className="max-w-4xl mx-auto bg-gradient-playful-pink border-2 border-primary/30 mb-12 game-card-3d animate-scale-in">
              ...
              <CardContent className="p-8">
                <p className="font-body text-xl text-white/90 mb-8 leading-relaxed">
                  Dive into our magical world of educational games designed to
                  make learning fun and engaging! Each game is carefully crafted
                  to support cognitive development and skill building.
                </p>
                <Link
                  href="https://68d28836301779fd7ee92684.heyboss.live/start"
                  target="_blank"
                  rel="noopener noreferrer"
                  passHref
                >
                  <Button
                    className="games-button font-heading text-2xl px-12 py-6 rounded-2xl"
                    size="lg"
                  >
                    <span className="mr-3 text-3xl animate-bounce-gentle">
                      🚀
                    </span>
                    Start Playing Games!
                    <span className="ml-3 text-3xl animate-bounce-gentle">
                      🌟
                    </span>
                  </Button>
                </Link>
                <p className="font-body text-white/80 mt-4 text-sm">
                  * Games will be available soon - this button is ready for your
                  link!
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="max-w-4xl mx-auto bg-gradient-to-r from-primary/10 to-accent/10 border-2 border-primary/20 mb-8 animate-fade-in-up">
              ...
              <CardContent>
                <p className="font-body text-lg text-muted-foreground mb-6">
                  Explore our comprehensive learning materials in an interactive
                  flipbook format
                </p>
                <FlipbookViewer />
              </CardContent>
