...
// Removed setPageSpecificCommands (not needed anymore)
import { useVoice } from "@/context/VoiceControlContext";

export default function SarathiHomepage() {
  // Access voice context but only what’s defined
  const { startListening, stopListening, isListening } = useVoice();

  // --- Your team's original code starts here ---
        ...
        <div className="container mx-auto text-center relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
              ...
              >
                <Play className="w-6 h-6 mr-2" />
                {isListening ? "Stop Listening" : "Start Your Journey"}
              </Button>
              <Button
                size="lg"
                variant="outline"
